 ...
 */
@Data
@JsonTypeInfo (use = JsonTypeInfo.Id.NAME, property = "type",visible =true,defaultImpl = FileDataTemplate.class)
@JsonSubTypes ({@JsonSubTypes.Type(value = FileDataTemplate.class, name = "file")
        ...
        @JsonSubTypes.Type(value = ParameterSliderDataTemplate.class, name = "parameter_slider"),
        @JsonSubTypes.Type(value = ParameterRangeDataTemplate.class, name = "parameter_range"),
